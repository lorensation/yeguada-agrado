...
export default function InstalacionesSection() {
  const instalaciones = [
    {
      ...
      image: "/instalaciones/instalaciones1.jpg",
    },
    {
      ...
      image: "/instalaciones/instalaciones2.jpg",
    },
    {
      title: "Caminador",
      ...
      image: "/instalaciones/instalaciones3.jpg",
    },
    {
    ...
    },
    {
      ...
      image: "/instalaciones/instalaciones5.jpg",
    },
    {
      ...
      image: "/instalaciones/instalaciones6.jpg",
    },
  ]
  ...
  return (
    <section id="instalaciones" className="py-16">
      ...
      <p className="text-primary text-center max-w-3xl mx-auto mb-12">
