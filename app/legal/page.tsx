      ...
      <div className="mt-12 prose prose-lg max-w-none">
        <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-lg shadow-md">
          <p className="mb-6 text-primary">
            ...
            Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles 
          ...
          <ul className="list-disc text-primary pl-6 mb-6">
            ...
            <li><strong>Domicilio:</strong> Ctra. M507, Km. 20,500 ALDEA DEL FRESNO (MADRID)</li>
          ...
          <p className="mb-6 text-primary">
            ...
            en los términos indicados en la sección de Política de Privacidad.
          </p>
          ...
          <p className="mb-6 text-primary">
            ...
            Intelectual y todas las marcas, nombres comerciales o signos distintivos, todos los derechos de propiedad 
            industrial e intelectual, sobre los contenidos y/o cualesquiera otros elementos insertados en el página, 
            que son propiedad exclusiva de la empresa y/o de terceros, quienes tienen el derecho exclusivo de utilizarlos 
            en el tráfico económico. Por todo ello el Usuario se compromete a no reproducir, copiar, distribuir, poner 
            a disposición o de cualquier otra forma comunicar públicamente, transformar o modificar tales contenidos 
          ...
          <p className="mb-6 text-primary">
            ...
            explotación, reproducción, distribución o comunicación pública del Espacio Web y/o de sus Contenidos distintos 
            de los aquí expresamente previstos. Cualquier otro uso o explotación de cualesquiera derechos estará sujeto a 
            la previa y expresa autorización específicamente otorgada a tal efecto por la empresa o el tercero titular de 
          ...
          <p className="mb-6 text-primary">
            ...
            intelectual. La empresa es titular de los elementos que integran el diseño gráfico del Espacio Web, lo menús, 
            botones de navegación, el código HTML, los textos, imágenes, texturas, gráficos y cualquier otro contenido del 
            Espacio Web o, en cualquier caso dispone de la correspondiente autorización para la utilización de dichos elementos. 
            El contenido dispuesto en el Espacio Web no podrá ser reproducido ni en todo ni en parte, ni transmitido, ni 
            registrado por ningún sistema de recuperación de información, en ninguna forma ni en ningún medio, a menos que 
          ...
          <p className="mb-6 text-primary">
            ...
            reservándose en todo caso la empresa el ejercicio de cuantos medios o acciones legales le correspondan en defensa 
          ...
          <p className="mb-6 text-primary">
            ...
            gastos derivados del uso del Espacio Web.
          </p>
          ...
          <p className="mb-6 text-primary">
            ...
            ni/o de parte ofertante de los servicios y/o información que se puedan ofrecer a terceros a través de los 
            enlaces de terceros.
          </p>
          ...
          <p className="mb-6 text-primary">
            ...
            de los datos personales, así como el establecimiento de las finalidades previamente establecidas, en las 
            condiciones definidas en la Política de Privacidad.
          </p>
          ...
          <p className="mb-6 text-primary">
            ...
            en su disco duro. Por favor consulte las instrucciones y manuales de su navegador para ampliar esta información.
          </p>
